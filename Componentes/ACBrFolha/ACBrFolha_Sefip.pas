...
type
  ...
  *******************************************************************************}
  ...
  { A competência 13 destina-se exclusivamente à geração de informações à Previdência Social.
    ...
    Os códigos de recolhimento 418 e 604, a ausência de fato gerador e a exclusão de informações devem ser utilizados exclusivamente na Entrada de dados do SEFIP.}
  TRegistroTipo00 = class
  private
    FTipoRegistro:                              String; // N 2. Campo obrigatório. Sempre “00”.
    /// Brancos. 51 AN - Campo obrigatório. Preencher com brancos Tratar dele no momento de gerar o registro.
    FTipoRemessa:                               String; { (Para indicar se o arquivo referese a recolhimento mensal ou recolhimento específico do FGTS).
    ...
    FTipoInscricaoResponsavel:                  String; {1 N. Campo obrigatório. Só pode ser 1 (CNPJ), 2 (CEI) ou 3 (CPF).
      Só pode ser igual a 3 (CPF), para o código de recolhimento 418.}
    FInscricaoResponsavel:                      String; {14 N. Campo obrigatório.
    ...
    FNomeResponsavel:                           String; {30 AN. Campo obrigatório. Não pode conter caracteres especiais.
    ...
    FNomeContato:                               String; {20 A. Campo obrigatório. Não pode conter número. Não pode conter caracteres especiais.
    ...
    FLogradouro:                                String; {50 AN. Campo obrigatório. Não pode conter caracteres especiais.
      Não pode haver caracteres acentuados. Não é permitido mais de um espaço entre os nomes.
      Não é permitido três ou mais caracteres iguais consecutivos. A primeira posição não pode ser branco.
    ...
    FCompetencia:                               String; { 6 D -  Campo obrigatório. Formato AAAAMM, onde AAAA indica o ano e MM o mês da competência. O mês informado deve ser de 1 a 13
    ...
    FIndicadorRecolhimentoFGTS:                 String; { 1 N - (Para identificar se o recolhimento será realizado no prazo, em atraso,
    ...
    FModalidadeArquivo:                         String; { 1 N - (Para identificar a que tipo de modalidade o arquivo se refere)
    ...
    FDataRecolhimentoFGTS:                      TDateTime; { 8 D - (Indicar a data efetiva de recolhimento do FGTS, sempre que o
  ...
  public
    ...
    property NomePessoaContato:                         String    read FNomeContato                               write FNomeContato;
  ...
  private
    ...
    FBairro:                                      String; { 20 AN - Campo obrigatório. Não pode conter caracteres especiais. Não pode haver caracteres acentuados.
      ...
      Pode conter apenas caracteres de A a Z e números de 0 a 9. }
    FCep:                                         String; // 8 N - Campo obrigatório. Número de CEP válido. Permitido apenas, números diferentes de 20000000, 30000000, 70000000 ou 80000000.
    FCidade:                                      String; { 20 AN - Campo obrigatório. Não pode conter caracteres especiais.
    ...
    FUnidadeFederacao:                            String; // 2 A - Campo obrigatório. Deve constar da tabela de unidades da federação
    FTelefoneContato:                             String; // 12 N - Campo obrigatório. Deve conter no mínimo 02 dígitos válidos no DDD e 07 dígitos no telefone.
    FIndicadorAlteracaoEndereco:                  String; { 1 A - Campo obrigatório. Só pode ser “S” ou “s” quando a empresa desejar
      alterar o endereço e “N” ou “n” quando não desejar modificá-lo. Para a competência 13, preencher com “N” ou “n”. }
    FCNAE:                                        String; { 7 N - Campo obrigatório. Número válido de CNAE. Para empregador doméstico
      utilizar o número 9700500.}
    FIndicadorAlteracaoCNAE:                      String; { 1 A - Campo obrigatório. Para os códigos 145, 307, 317, 327, 337, 345,
    ...
    FAliquotaRAT:                                 String; { 2 N - (Informar alíquota para o cálculo da contribuição destinada ao
      ...
      Sempre que não informado o campo deve ficar em branco. }
    FCodigoCentralizacao:                         String; { 1 N - (Para indicar as empresas que centralizam o recolhimento do FGTS ).
    ...
    FSIMPLES:                                     String; { 1 N -(Para indicar se a empresa é ou não optante pelo SIMPLES -
    ...
    FFPAS:                                        String; { 3 N - (Informar o código referente à atividade econômica principal do
    ...
    FCodigoOutrasEntidades:                       String; { 4 N - (Informar o código de outras entidades e fundos para as quais
      ...
      Sempre que não informado o campo deve ficar em branco. }
    FCodigoPagamentoGPS:                          String; { 4 N - (Informar o código de pagamento da GPS, conforme tabela divulgada
      ...
      Sempre que não informado o campo deve ficar em branco. }
    FPercentualIsencaoFilantropia:                String; { 5 N - (Informar o percentual de isenção conforme Lei 9.732/98)
      Valor deve ser composto de três inteiros e duas decimais. Só pode ser informado quando o FPAS for igual a 639.
      Sempre que não informado o campo deve ficar em branco. }
    FSalarioFamilia:                              Double; { 15 V - (Informar o total pago pela empresa a título de saláriofamília.
    ...
    FValorDevidoPrevidenciaSocialReferenteComp13: Double; { 14 V - (Informar o valor total devido à Previdência Social, na competência 13).
      Não deverá ser informado. Preencher com zeros. }
    FBanco:                                       String; { 3 N - “Para débito em conta corrente. Implementação futura”
...
procedure TRegistroTipo13List.SetItem(Index: Integer;
  const Value: TRegistroTipo13);
begin
  Put(Index, Value);
end;
...
procedure TRegistroTipo14List.SetItem(Index: Integer;
  const Value: TRegistroTipo14);
begin
  Put(Index, Value);
end;
...
procedure TRegistroTipo20List.SetItem(Index: Integer;
  const Value: TRegistroTipo20);
begin
  Put(Index, Value);
end;
...
procedure TRegistroTipo21List.SetItem(Index: Integer;
  const Value: TRegistroTipo21);
begin
  Put(Index, Value);
end;
...
procedure TRegistroTipo30List.SetItem(Index: Integer;
  const Value: TRegistroTipo30);
begin
  Put(Index, Value);
end;
...
procedure TRegistroTipo32List.SetItem(Index: Integer;
  const Value: TRegistroTipo32);
begin
  Put(Index, Value);
end;
...
procedure TRegistroTipo50List.SetItem(Index: Integer;
  const Value: TRegistroTipo50);
begin
  Put(Index, Value);
end;
...
procedure TRegistroTipo51List.SetItem(Index: Integer;
  const Value: TRegistroTipo51);
begin
  Put(Index, Value);
end;
