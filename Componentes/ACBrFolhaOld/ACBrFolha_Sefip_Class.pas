...
uses SysUtils, Classes, DateUtils, ACBrTXTClass, ACBrFolha_Sefip, ACBrFolhaUtils;
  ...
  begin
     ...
     begin
       ...
       Result := LFill('00') +
                 ...
                 RFill(TratarString(NomeResponsavelRazaoSocial), 30) +
                 ...
                 RFill(FormatDateTime('YYYYMM', Competencia), 6) +
     ...
     begin
        ...
        begin
          ...
          if FRegistroTipo00.TipoInscricaoResponsavel = '1' then
           ...
           ///
          strRegistroTipo12 :=  strRegistroTipo12 + LFill('12')+
          LFill(TipoInscricaoEmpresa,1) +
          LFill(InscricaoEmpresa, 14) +
          LFill('0', 36) +
     ...
     begin
        ...
        begin
          ...
          if FRegistroTipo00.TipoInscricaoResponsavel = '1' then
           ...
           ///
           strRegistroTipo13 :=  strRegistroTipo13 + LFill('013') +
     ...
     begin
        ...
        begin
          ...
          if FRegistroTipo00.TipoInscricaoResponsavel = '1' then
           ...
           Check(ValidarCEP(CEP, UnidadeFederacao), '(0-0000) O Cep "%s" digitada é inválida!', [CEP]);
           ///
           strRegistroTipo14 :=  strRegistroTipo14 + LFill('014') +
           LFill(TipoInscricaoEmpresa, 1) +
           LFill(InscricaoEmpresa, 14) +
           LFill('0', 36) +
           LFill(PISPASEPCI, 11) +
     ...
     begin
        ...
        begin
          ...
          if FRegistroTipo00.TipoInscricaoResponsavel = '1' then
           ...
           Check(ValidarCEP(CEP, UnidadeFederacao), '(0-0000) O Cep "%s" digitada é inválida!', [CEP]);
           ///
           strRegistroTipo20 :=  strRegistroTipo20 + LFill('020') +
           LFill(TipoInscricaoEmpresa, 1) +
           LFill(InscricaoEmpresa, 14) +
     ...
     begin
        ...
        begin
          ...
          if FRegistroTipo00.TipoInscricaoResponsavel = '1' then
           ...
           Check(ValidarCnpjCeiCpf(InscricaoTomadorObraConstCivil), '(0-0000) O CEI "%s" digitado é inválido!', [InscricaoTomadorObraConstCivil]);
          ///
           strRegistroTipo21 :=  strRegistroTipo21 + LFill('021') +
           LFill(TipoInscricaoEmpresa, 1) +
           LFill(InscricaoEmpresa, 14) +
           LFill(TipoInscricaoTomadorObraConstCivil, 1) +
           LFill(InscricaoTomadorObraConstCivil, 14) +
     ...
     begin
        ...
        begin
          ...
          if FRegistroTipo00.TipoInscricaoResponsavel = '1' then
           ...
           Check(ValidarPis(PISPASEPCI), '(0-0000) O PIS - PASEP - CI "%s" digitado é inválido!', [PISPASEPCI]);
           ///
           strRegistroTipo30 :=  strRegistroTipo30 + LFill('030') +
           LFill(TipoInscricaoEmpresa, 1) +
           LFill(InscricaoEmpresa, 14) +
           LFill(TipoInscricaoTomadorObraConstCivil, 1) +
           LFill(InscricaoTomadorObraConstCivil, 14) +
     ...
     begin
        ...
        begin
          ...
          if FRegistroTipo00.TipoInscricaoResponsavel = '1' then
           ...
           Check(ValidarPis(PISPASEPCI), '(0-0000) O PIS - PASEP - CI "%s" digitado é inválido!', [PISPASEPCI]);
           ///
           strRegistroTipo32 :=  strRegistroTipo32 + LFill('032') +
           LFill(TipoInscricaoEmpresa, 1) +
           LFill(InscricaoEmpresa, 14) +
           LFill(TipoInscricaoTomadorObraConstCivil, 1) +
           LFill(InscricaoTomadorObraConstCivil, 14) +
     ...
     begin
        ...
        begin
          ...
          Check(((CodigoCentralizacao = '0') or (CodigoCentralizacao = '1') or (CodigoCentralizacao = '2')), '(0-0000) Campo obrigatório.  Só pode ser 0 (não centraliza), 1 (centralizadora) ou 2 (centralizada).', [TipoInscricaoEmpresa]);
           ...
           ///
           strRegistroTipo50 :=  strRegistroTipo50 + LFill('050') +
           LFill(TipoInscricaoEmpresa, 1) +
           LFill(InscricaoEmpresa, 14) +
           LFill('0', 36) +
     ...
     begin
        ...
        begin
          ...
          if FRegistroTipo00.TipoInscricaoResponsavel = '1' then
           ...
           ///
           strRegistroTipo51 :=  strRegistroTipo51 + LFill('051') +
           LFill(TipoInscricaoEmpresa, 1) +
           LFill(InscricaoEmpresa, 14) +
           LFill(TipoInscricaoTomador, 1) +
           LFill(InscricaoTomador, 14) +
