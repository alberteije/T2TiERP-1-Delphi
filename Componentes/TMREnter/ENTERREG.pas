...
{=======================================================================}
{                                                                       }
{   Para que fosse possível a utilização deste componente no Delphi 6   }
{   e no Delphi 7, precisei excluir (apagar mesmo) os códigos relativos }
{   à criação e exibição da caixa Sobre (About...)que não eram          }
{   compatíveis com essas versões do delphi, já que utilizavam a unit   }
{   dsnintf.pas, e apresentavam erro de proxies.pas ao migrar para as   }
{   novas units disponibilizadas pela Borland.                          }
{                                                                       }
{   Cabe deixar claro que apenas modifique algumas propriedades do      }
{   componente, não sendo o mesmo da minha autoria.                     }
{                                                                       }
{   Este ótimo componente tem a autoria do Martins, conforme acima.     }
{                                                                       }
{   Colaborador:                                                        }
{   Edson Cabral (adm.cabral@yahoo.com.br)                              }
{                                                                       }
{=======================================================================}
