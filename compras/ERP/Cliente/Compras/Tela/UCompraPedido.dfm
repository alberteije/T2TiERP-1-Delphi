      ...
      inherited PanelEdits: TPanel
        ...
        object GroupBoxItensPedido: TGroupBox
          ...
          object GridCompraPedidoDetalhe: TJvDBUltimGrid
            ...
            TitleRowHeight = 17
            SortWith = swFields
            OnUserSort = GridCompraPedidoDetalheUserSort
            Columns = <
              item
                Expanded = False
                FieldName = 'ID'
        ...
        object EditIdCompraTipoPedido: TLabeledCalcEdit
          ...
          TabOrder = 2
          DecimalPlacesAlwaysShown = False
          OnExit = EditIdCompraTipoPedidoExit
          OnKeyDown = EditIdCompraTipoPedidoKeyDown
          OnKeyPress = EditIdCompraTipoPedidoKeyPress
          CalcEditLabel.Width = 82
          CalcEditLabel.Height = 13
