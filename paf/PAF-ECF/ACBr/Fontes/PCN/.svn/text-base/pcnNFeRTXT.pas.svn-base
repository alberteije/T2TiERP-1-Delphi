...
begin
  ...
  begin
    (*F02*)NFe.Retirada.CNPJ := LerCampo(tcStr, 'CNPJ');
  ...
  begin
    (*G***)NFe.Entrega.CNPJ := LerCampo(tcStr, 'CNPJ');
  ...
  begin
    ...
    (*J07*)NFe.Det[i].Prod.veicProd.CM3 := LerCampo(tcStr, 'CM3');
    ...
    (*J13*)NFe.Det[i].Prod.veicProd.CMKG := LerCampo(tcStr, 'CMKG');
