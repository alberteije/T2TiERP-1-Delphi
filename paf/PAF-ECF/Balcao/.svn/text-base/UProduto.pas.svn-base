  ...
  try
    try
      ...
      begin
        ...
        VerificaNULL(CDSProduto.FieldByName('GTIN').AsString,1)+'|'+                //  VARCHAR(14),
        VerificaNULL(CDSProduto.FieldByName('CODIGO_INTERNO').AsString,1)+'|'+      //  VARCHAR(20),
        VerificaNULL(CDSProduto.FieldByName('NOME').AsString,1)+'|'+                //  VARCHAR(100),
        VerificaNULL(CDSProduto.FieldByName('DESCRICAO').AsString,1)+'|'+           //  VARCHAR(250),
        VerificaNULL(CDSProduto.FieldByName('DESCRICAO_PDV').AsString,1)+'|'+       //  VARCHAR(30),
        ...
        VerificaNULL(CDSProduto.FieldByName('IAT').AsString,1)+'|'+                 //  CHAR(1),
        VerificaNULL(CDSProduto.FieldByName('IPPT').AsString,1)+'|'+                //  CHAR(1),
        VerificaNULL(CDSProduto.FieldByName('NCM').AsString,1)+'|'+                 //  VARCHAR(8),
        VerificaNULL(CDSProduto.FieldByName('TIPO_ITEM_SPED').AsString,1)+'|'+      //  CHAR(2),
        QuotedStr(DataParaTexto(CDSProduto.FieldByName('DATA_ESTOQUE').AsDateTime))+'|'+        //  DATE,
        ...
        VerificaNULL(CDSProduto.FieldByName('CST').AsString,1)+'|'+                 //  CHAR(3),
        VerificaNULL(CDSProduto.FieldByName('CSOSN').AsString,1)+'|'+               //  CHAR(4),
        VerificaNULL(CDSProduto.FieldByName('TOTALIZADOR_PARCIAL').AsString,1)+'|'+ //  VARCHAR(10),
        VerificaNULL(CDSProduto.FieldByName('ECF_ICMS_ST').AsString,1)+'|'+         //  VARCHAR(4),
        VerificaNULL(CDSProduto.FieldByName('CODIGO_BALANCA').AsString,0)+'|'+      //  INTEGER,
        VerificaNULL(CDSProduto.FieldByName('PAF_P_ST').AsString,1)+'|'+            //  CHAR(1),
        VerificaNULL(MD5String(Tripa), 1)+'|'+                                                 //  VARCHAR(32),
        '0|');                                                                      //  INTEGER
