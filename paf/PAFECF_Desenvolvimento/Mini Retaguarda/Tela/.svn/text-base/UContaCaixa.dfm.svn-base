object FContaCaixa: TFContaCaixa
  Tag = 1
  Left = 139
  Top = 167
  Caption = 'Contas Banc'#225'rias / Caixas'
  ClientHeight = 468
  ClientWidth = 900
  Color = clBtnFace
  ...
  object PanelEdits: TPanel
    ...
    object EditNomeAgencia: TLabeledEdit
      Left = 89
      Top = 64
      Width = 792
      Height = 21
    ...
    object EditIdAgencia: TJvValidateEdit
      Left = 18
      Top = 64
      Width = 71
      Height = 21
      ...
      TabOrder = 0
      OnKeyDown = EditIdAgenciaKeyDown
    end
  ...
  object PanelGrid: TPanel
    ...
    object Grid: TJvDBUltimGrid
      ...
      Height = 373
      Align = alClient
      DataSource = FDataModule.DSContaCaixa
      ReadOnly = True
      TabOrder = 0
