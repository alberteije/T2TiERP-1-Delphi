object FImpostoIcms: TFImpostoIcms
  Tag = 1
  Left = 307
  Top = 250
  ...
  object PanelGrid: TPanel
    ...
    object Grid: TJvDBUltimGrid
      ...
      Height = 373
      Align = alClient
      DataSource = FDataModule.DSImpostoIcms
      ReadOnly = True
      TabOrder = 0
    ...
    object PanelFiltroRapido: TPanel
      ...
      object BtnFiltroRapido: TSpeedButton
        Left = 756
        Top = 24
        Width = 125
        Height = 22
  ...
  object PanelEdits: TPanel
    ...
    object EditAliquotaICMS: TJvCalcEdit
      Left = 272
      Top = 65
      Width = 90
      Height = 21
    ...
    object EditREDUCAO_BASE_CALCULO: TJvCalcEdit
      Left = 368
      Top = 65
      Width = 90
      Height = 21
    ...
    object EditALIQUOTA_ICMS_ECF: TJvCalcEdit
      Left = 768
      Top = 65
      Width = 109
      Height = 21
    ...
    object EditTOTALIZADOR_PARCIAL: TEdit
      Left = 18
      Top = 105
      Width = 121
      Height = 21
    ...
    object EditECF_ICMS_ST: TEdit
      ...
      AutoSize = False
      TabOrder = 8
      OnKeyDown = EditECF_ICMS_STKeyDown
    end
    object EditCFOP: TEdit
      ...
      AutoSize = False
      TabOrder = 0
      OnKeyDown = EditCFOPKeyDown
    end
    object EditTributacao: TComboBox
      Left = 595
      Top = 65
      Width = 162
      Height = 21
