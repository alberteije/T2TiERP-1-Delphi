object FLancamentoReceber: TFLancamentoReceber
  Tag = 1
  Left = 340
  Top = 237
  Action = ActionSair
  ...
  object PanelEdits: TPanel
    ...
    object EditNomeTipoDocumento: TLabeledEdit
      Left = 89
      Top = 106
      Width = 787
      Height = 21
    ...
    object EditQuantidadeParcelas: TJvValidateEdit
      Left = 275
      Top = 196
      Width = 103
      Height = 21
    ...
    object GridParcelas: TJvDBUltimGrid
      ...
      DataSource = FDataModule.DSParcelaReceber
      TabOrder = 10
    ...
    object EditPrimeiroVencimento: TJvDateEdit
      Left = 516
      Top = 196
      Width = 113
      Height = 21
    ...
    object EditIdCliente: TJvValidateEdit
      Left = 18
      Top = 64
      Width = 71
      Height = 21
    ...
    object EditIdTipoDocumento: TJvValidateEdit
      Left = 18
      Top = 106
      Width = 71
      Height = 21
      ...
      CriticalPoints.MinValueIncluded = False
      TabOrder = 2
      OnKeyDown = EditIdTipoDocumentoKeyDown
    end
    ...
    object EditDescricaoConta: TLabeledEdit
      Left = 89
      Top = 148
      Width = 787
      Height = 21
  ...
  object ActionManager: TActionManager
    ...
    ActionBars = <
      ...
      item
        Items = <
          ...
          item
            Action = ActionGerarParcelar
            Caption = '&Gerar Parcelas'
            ImageIndex = 29
          end
          item
            Action = ActionEmitirBoletos
    ...
    object ActionGerarParcelar: TAction
      Category = 'ContasAReceber'
      Caption = 'Gerar Parcelas'
      ImageIndex = 29
      OnExecute = ActionGerarParcelarExecute
    end
    object ActionEmitirBoletos: TAction
      Category = 'ContasAReceber'
      Caption = 'Emitir Boletos'
      ImageIndex = 32
      OnExecute = ActionEmitirBoletosExecute
    end
  end
