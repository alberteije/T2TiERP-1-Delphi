object FParcelaPagamento: TFParcelaPagamento
  Tag = 1
  Left = 330
  Top = 216
  ...
  object PanelGrid: TPanel
    ...
    object Grid: TJvDBUltimGrid
      ...
      Height = 387
      Align = alClient
      DataSource = FDataModule.DSLancamentoPagar
      ReadOnly = True
      TabOrder = 0
  ...
  object PanelEdits: TPanel
    ...
    object PanelEditsInterno: TPanel
      ...
      object EditDataPagamento: TJvDateEdit
        Left = 12
        Top = 112
        Width = 109
        Height = 21
      ...
      object EditValorPago: TJvValidateEdit
        Left = 738
        Top = 112
        Width = 100
        Height = 21
    ...
    object GridParcelas: TJvDBUltimGrid
      ...
      DataSource = FDataModule.DSParcelaPagamento
      ReadOnly = True
      TabOrder = 2
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
      ...
      item
        Items = <
          item
            ...
            Caption = '&Confirmar Pagamento [F3]'
            ImageIndex = 1
            ShortCut = 114
          end
          item
