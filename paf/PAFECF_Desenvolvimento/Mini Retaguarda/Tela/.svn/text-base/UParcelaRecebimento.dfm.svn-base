object FParcelaRecebimento: TFParcelaRecebimento
  Tag = 1
  Left = 330
  Top = 216
  ...
  object PanelGrid: TPanel
    ...
    object Grid: TJvDBUltimGrid
      ...
      Height = 387
      Align = alClient
      DataSource = FDataModule.DSLancamentoReceber
      ReadOnly = True
      TabOrder = 0
  ...
  object PanelEdits: TPanel
    ...
    object PanelEditsInterno: TPanel
      ...
      object EditTaxaJuro: TJvValidateEdit
        Left = 246
        Top = 112
        Width = 50
        Height = 21
        ...
        EditText = '0'
        TabOrder = 6
        OnExit = EditTaxaJuroExit
      end
      object EditDataRecebimento: TJvDateEdit
        Left = 12
        Top = 112
        Width = 109
        Height = 21
      ...
      object EditValorJuro: TJvValidateEdit
        Left = 296
        Top = 112
        Width = 100
        Height = 21
      ...
      object EditTaxaMulta: TJvValidateEdit
        Left = 411
        Top = 112
        Width = 50
        Height = 21
        ...
        DecimalPlaces = 2
        TabOrder = 8
        OnExit = EditTaxaMultaExit
      end
      object EditValorMulta: TJvValidateEdit
        Left = 461
        Top = 112
        Width = 100
        Height = 21
      ...
      object EditValorDesconto: TJvValidateEdit
        Left = 624
        Top = 112
        Width = 100
        Height = 21
      ...
      object EditTaxaDesconto: TJvValidateEdit
        Left = 574
        Top = 112
        Width = 50
        Height = 21
      ...
      object EditIdContaCaixa: TJvValidateEdit
        Left = 12
        Top = 24
        Width = 59
        Height = 21
      ...
      object EditNomeContaCaixa: TLabeledEdit
        Left = 71
        Top = 24
        Width = 767
        Height = 21
      ...
      object EditIdMeioPagamento: TJvValidateEdit
        Left = 12
        Top = 68
        Width = 59
        Height = 21
        ...
        CriticalPoints.MinValueIncluded = False
        TabOrder = 2
        OnKeyDown = EditIdMeioPagamentoKeyDown
      end
      object EditDescricaoMeioPagamento: TLabeledEdit
        Left = 71
        Top = 68
        Width = 767
        Height = 21
      ...
      object EditValorRecebido: TJvValidateEdit
        ...
        ReadOnly = True
        TabOrder = 12
        OnEnter = EditValorRecebidoEnter
      end
    end
    ...
    object GridParcelas: TJvDBUltimGrid
      ...
      DataSource = FDataModule.DSParcelaRecebimento
      ReadOnly = True
      TabOrder = 2
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
  ...
  object ActionManager: TActionManager
    ...
    ActionBars = <
      item
        Items = <
          item
            Action = ActionConfirmarRecebimento
            Caption = '&Confirmar Recebimento [F3]'
            ImageIndex = 1
            ShortCut = 114
          end
          item
      ...
      item
        Items = <
          ...
          item
            Action = ActionConfirmarParcela
            Caption = 'C&onfirmar Recebimento'
            ImageIndex = 30
          end>
    ...
    object ActionConfirmarRecebimento: TAction
      Category = 'Cadastro'
      Caption = 'Confirmar Recebimento [F3]'
      ImageIndex = 1
      ShortCut = 114
      OnExecute = ActionConfirmarRecebimentoExecute
    end
    ...
    object ActionConfirmarParcela: TAction
      Category = 'Recebimentos'
      Caption = 'Confirmar Recebimento'
      ImageIndex = 30
      OnExecute = ActionConfirmarParcelaExecute
    end
  end
