object FPessoa: TFPessoa
  ...
  object PanelEdits: TPanel
    ...
    object EditNomeSituacaoPessoa: TLabeledEdit
      Left = 89
      Top = 64
      Width = 792
      Height = 21
    ...
    object EditIdSituacaoPessoa: TJvValidateEdit
      Left = 18
      Top = 64
      Width = 71
      Height = 21
      ...
      TabOrder = 0
      OnKeyDown = EditIdSituacaoPessoaKeyDown
    end
    ...
    object RadioFisicaJuridica: TRadioGroup
      Left = 250
      Top = 295
      Width = 159
      Height = 36
    ...
    object EditRg: TLabeledEdit
      ...
      EditLabel.Width = 97
      EditLabel.Height = 13
      EditLabel.Caption = 'Registro Geral (RG):'
      MaxLength = 30
      TabOrder = 12
    end
    object EditOrgaoRg: TLabeledEdit
      Left = 590
      Top = 264
      Width = 150
      Height = 21
      EditLabel.Width = 51
      EditLabel.Height = 13
      EditLabel.Caption = #211'rg'#227'o RG:'
      MaxLength = 30
      TabOrder = 13
    end
    object EditDataEmissaoRg: TJvDateEdit
      Left = 756
      Top = 264
      Width = 121
      Height = 21
    ...
    object GridEnderecos: TJvDBUltimGrid
      Left = 10
      Top = 352
      Width = 879
      Height = 168
      Anchors = [akLeft, akTop, akRight, akBottom]
      DataSource = FDataModule.DSPessoaEndereco
      TabOrder = 18
      ...
      TitleFont.Style = []
      OnKeyDown = GridEnderecosKeyDown
      TitleButtons = True
  ...
  object PanelGrid: TPanel
    ...
    object Grid: TJvDBUltimGrid
      ...
      Height = 472
      Align = alClient
      DataSource = FDataModule.DSPessoa
      ReadOnly = True
      TabOrder = 0
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
