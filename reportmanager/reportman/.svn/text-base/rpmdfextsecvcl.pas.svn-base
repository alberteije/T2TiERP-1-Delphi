...
function ChangeExternalSectionProps(report:TRpReport;section:TRpSection):Boolean;
var
 dia:TFRpExtSectionVCL;
begin
 Result:=False;
 dia:=TFRpExtSectionVCL.Create(Application);
 try
  dia.FReport:=report;
...
procedure TFRpExtSectionVCL.FormCreate(Sender: TObject);
begin
 // Load translations
...
procedure TFRpExtSectionVCL.UpdateCombos;
var
 i:integer;
begin
...
procedure TFRpExtSectionVCL.ComboReportFieldDropDown(Sender: TObject);
var
 index:integer;
 sqlsentence:String;
 adata:TDataset;
...
procedure TFRpExtSectionVCL.ComboSearchValueDropDown(Sender: TObject);
var
 index:integer;
 sqlsentence:String;
 adata:TDataset;
...
procedure TFRpExtSectionVCL.ValidateRecord;
var
 index:integer;
 sqlsentence:String;
 adata:TDataset;
