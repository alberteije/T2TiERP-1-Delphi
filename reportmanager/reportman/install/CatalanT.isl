...
SelectStartMenuFolderLabel3=La instal.lació crearà el grup de programes al menú inici.
SelectStartMenuFolderBrowseLabel=Per continuar faci clic a següent, pot seleccionar una carpeta diferent.
SelectDirBrowseLabel=Per continuar, faci clic a següent, pot seleccionar una carpeta diferent.
SelectDirLabel3=La instal.lació copiarà [name] a la carpeta.
...
CreateQuickLaunchIcon=Crear una icona a la barra del menú inici
...
ServerconfigurationXP=Utilitat de configuració del servidor de xarxa
