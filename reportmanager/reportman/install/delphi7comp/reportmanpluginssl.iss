...
[Setup]
AppName=Report Manager ActiveX plugin ssl enabled
...
Source: ..\webactivex\ssl\liebeay32.dll; DestDir: {sys}; Flags: restartreplace sharedfile ignoreversion
Source: ..\webactivex\ssl\ssleay32.dll; DestDir: {sys}; Flags: restartreplace sharedfile ignoreversion
