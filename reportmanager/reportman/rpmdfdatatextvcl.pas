...
begin
 ...
 dia:=TFRpDataTextVCL.Create(Application);
 try
...
procedure TFRpDataTextVCL.ReadFromFile;
var
...
procedure TFRpDataTextVCL.FillList;
var
 i:integer;
 aobj:TRpFieldObj;
begin
...
procedure TFRpDataTextVCL.FormShow(Sender: TObject);
begin
...
procedure TFRpDataTextVCL.ConvertToLFields;
var
 aobj:TRpFieldObj;
begin
...
procedure TFRpDataTextVCL.DoSave;
var
 recordseparator:char;
 ignoreafterrecordseparator:char;
begin
...
procedure TFRpDataTextVCL.BOkClick(Sender: TObject);
begin
 DoSave;
 Close;
end;

procedure TFRpDataTextVCL.BCancelClick(Sender: TObject);
begin
 Close;
end;

procedure TFRpDataTextVCL.FormDestroy(Sender: TObject);
begin
 FreeFieldObjList(lfields);
 lfields.free;
end;
...
procedure TFRpDataTextVCL.ANewFieldExecute(Sender: TObject);
begin
 DFields.Insert;
end;

procedure TFRpDataTextVCL.ADeleteExecute(Sender: TObject);
begin
 DFields.Delete;
end;

procedure TFRpDataTextVCL.DFieldsNewRecord(DataSet: TDataSet);
begin
...
procedure TFRpDataTextVCL.BTestClick(Sender: TObject);
begin
 DoSave;
 DData.Close;
...
procedure TFRpDataTextVCL.Button1Click(Sender: TObject);
begin
 DoSave;
 Close;
end;
